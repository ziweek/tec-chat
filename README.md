...
> [!NOTE]
> - 본 아이디어는, 대한민국 육군본부에서 주최하는 [2024 대한민국 육군창업경진대회](https://www.army-startup.co.kr/)에 출품하여 00상을 수상한 프로젝트입니다.
>   
> - 본 아이디어는, 기존의 책자형 야전교범의 단점을 극복하기 위하여, 군사용 장비 운용부터 기능 고장 발생시까지 필요한 솔루션을 신속하고 정확하게 검색하고 대처방안을 도출할 수 있게 돕는 LLM(대규모 언어 모델) 챗봇 지능형 서비스을 연구 및 개발하는 것입니다.
