...
export default function Home() {
  ...
  return (
    <>
      <section
        className="flex flex-col items-center justify-start w-full min-h-screen gap-4 max-w-[400px] mx-auto"
        style={{
          display: "grid",
        ...
        <div className="flex flex-col items-center w-full h-full justify-start gap-8">
          ...
          <div className="px-4 leading-loose">
            ...
            <ul>
              ...
              <li>
                본 교범은 K9 자주포의 운용자 및 유지보수 요원에게 필수적인
                지침을 제공하여 전투 상황에서의 효율성과 안전을 보장합니다.
              </li>
            </ul>
            <br></br>
            ...
            <ol>
              ...
              <li>
                <strong>사격 준비:</strong> 자주포 및 관련 장비의 점검 및
                유지보수
              </li>
              <li>
            ...
            <ul>
              <li>
                K9 자주포의 정기적인 점검 및 유지보수 프로세스에 대한 이해와
                이행
              </li>
            </ul>
            <br></br>
